...
v[3] =['ALL'] ;
t[3] = v[3] ;
v[4] = ['FF','TT','TTHA','RH','NN','N75','LC','CH','PE1','PE3','PE6','VI']
t[4] = ['U10m','T2m','T2m, height corr.','Rh2m','Cloud cover','clouds <7500m','Low clouds','Cloud base','1h Precipitation','3h Precipitation','6h Precipitation','Visibility']
v[5] =[0]
v[5] =v[5].reverse()
t[5] =v[5]
